  ...
  return (
    <section>
      <div className="  w-full ">
        <div className="p-6  w-full flex flex-col  md:gap-10 justify-around items-center">
          <form
            action={handelSubmit}
        ...
        {/* Products */}
        <div className="bg-white w-full mt-7 pb-7 px-5 transition-all duration-100">
          {categoryData.product.length > 0 ? (
            ...
            <div className="w-full items-center justify-center gap-1 text-gray-500 flex ">
              {" "}
              <MessageCircleWarning /> No Products found in this
              category..!{" "}
            </div>
          )}
        </div>
